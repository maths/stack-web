...
$(document).ready(function() {
    ...
    function showInnerDropdown(item) {
        ...
        container.find('> .dropdown-submenu > a','> .dropdown-submenu-nohover > a').each(function(i, el) {
            if (el !== item) {
...
//         }
    ...
    function hideInnerDropdown(item) {
        ...
        popup.find('.dropdown-submenu > a','.dropdown-submenu-nohover > a').removeClass('open');
    }

    $('.dropdown-submenu > a').on('click', function(e) {
        if ($(this).next('.dropdown-menu').hasClass('show')) {
           hideInnerDropdown(this); $(".dropdown-menu").not(".dropdown-menu.show").parent(".dropdown-submenu-nohover").removeClass("dropdown-submenu-nohover").addClass("dropdown-submenu");
        } else {
           showInnerDropdown(this); $(".dropdown-menu").not(".dropdown-menu.show").parent(".dropdown-submenu").addClass("dropdown-submenu-nohover").removeClass("dropdown-submenu");
           $(this).parent().removeClass("dropdown-submenu-nohover").addClass("dropdown-submenu");
        }
