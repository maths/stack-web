...
<div class="float-none img-middle">
    <figure class="figure">
        <img class="figure-img img-fluid" src="../Images/Japan-moodle-moot-0.jpg" alt="A scene from the seminar style workshop" style="width:85%;">
        <figcaption class="figure-caption">Figure: A scene from the seminar style workshop</figcaption>
    </figure>
</div>
...
<div class="float-none img-middle">
    <figure class="figure">
        <img class="figure-img img-fluid" src="../Images/2026-03-Shizuoka-GGB.png" alt="A performance evaluation sample question using GeoGebra in STACK" style="width:85%;">
        <figcaption class="figure-caption">Figure: A performance evaluation sample question using GeoGebra in STACK</figcaption>
    </figure>
</div>
...
With an R&D grant from the Moodle Association of Japan, they have localised the documentation for the STACK question type—one of Moodle’s question type plugins—into Japanese. Whilst STACK itself has been largely localised, with the exception of a few sections, the [documentation](https://docs.stack-assessment.org/en/) that many teachers are likely to refer to when actually creating questions had previously only been localised up to the section covering the basics of question creation. They have now localised the entire documentation into Japanese, and this report detailed the results.
