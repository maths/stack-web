...
<figure class="figure">
<img class="figure-img img-fluid" src="../Images/2026-07-nairobi-group.png" alt="Participants at the 2026 International Meeting of the STACK Community in Nairobi">
...
<div class="col-md-6">
<figure class="figure">
<img class="figure-img img-fluid" src="../Images/2026-08-safari-rock-formation.png" alt="Participants exploring a rock formation in Nakuru Naivasha">
...
<div class="col-md-4">
<figure class="figure">
<img class="figure-img img-fluid" style="max-height: 90px; width: auto;" src="../Images/2026-07-university-nairobi-logo.jpg" alt="University of Nairobi logo">
<figcaption class="figure-caption text-center">University of Nairobi</figcaption>
</figure>
</div>
<div class="col-md-4">
<figure class="figure">
<img class="figure-img img-fluid" style="max-height: 90px; width: auto;" src="../../../img/innodems-logo.jpg" alt="INNODEMS logo">
<figcaption class="figure-caption text-center">INNODEMS</figcaption>
</figure>
</div>
<div class="col-md-4">
<figure class="figure">
<img class="figure-img img-fluid" style="max-height: 90px; width: auto;" src="../../../img/idems-logo.png" alt="IDEMS International logo">
...
<div class="col-md-6">
<figure class="figure">
<img class="figure-img img-fluid" style="max-height: 90px; width: auto;" src="../../2024/Images/caltech-logo.png" alt="Caltech logo">
<figcaption class="figure-caption text-center">Caltech</figcaption>
</figure>
</div>
<div class="col-md-6">
<figure class="figure">
<img class="figure-img img-fluid" style="max-height: 90px; width: auto;" src="../../../img/ems-logo.jpg" alt="European Mathematical Society logo">
