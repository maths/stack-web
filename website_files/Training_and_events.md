...
| ---------------------------------------------- | --------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Workshop: Effective use of Maxima**          | 2/12/2020<br>15:00-17:00 GMT             | Online. <br>[Register here](https://stack-demo.maths.ed.ac.uk/demo/course/view.php?id=69) | Learn how mathematics educators use Maxima effectively with STACK, and how to use more advanced Maxima techniques to improve your own STACK questions. |
